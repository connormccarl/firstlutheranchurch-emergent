      ...
      >
        ...
        <div className="p-6 space-y-4">
          {resource.fields.map((f) => {
            ...
            const common = {
              ...
              className:
                "w-full mt-1 rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
            };
            return (
              <div key={f.key}>
                <label
                ...
                {f.helpText && (
                  <p className="text-xs text-slate-500 mt-1">{f.helpText}</p>
                )}
              </div>
            );
          })}
          ...
          {error && (
            <p className="text-sm text-red-600" data-testid="cms-form-error">
              {error}
            </p>
          )}
        </div>
        ...
        <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-end gap-2 sticky bottom-0 bg-white">
          ...
          <button
            ...
            className="px-4 py-2 text-sm rounded-lg bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white inline-flex items-center gap-2"
          >
