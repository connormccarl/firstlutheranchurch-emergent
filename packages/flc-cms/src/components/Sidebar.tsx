...
export function Sidebar({ config, active, onLogout, extraNav }: SidebarProps) {
  const items = [
  ...
  return (
    <aside
      ...
      className="w-64 shrink-0 bg-slate-900 text-slate-200 flex flex-col"
    >
